...
// Source: github.com/emmyvera/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalnce(arg0 context.Context, arg1 db.AddAccountBalnceParams) (db.Account, error) {
	m.ctrl.T.Helper()
